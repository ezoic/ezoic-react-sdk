...
/** Ids appended one per click, capped at 125. */
const DYNAMIC_IDS: readonly number[] = [119, 120, 121, 122, 123, 124, 125];

/**
 * Appends a new numeric `<EzoicAd>` per click (ids 119–125) — the infinite
...
export function DynamicSection(): ReactElement {
  ...
  const addUnit = (): void => {
    if (atMax) {
      log('Dynamic ads: reached max id (125).');
      return;
    }
  ...
  return (
    <section className="section">
      ...
      <p className="section-desc">
        Each click appends a numeric EzoicAd (ids 119–125) — the infinite-scroll / load-more
