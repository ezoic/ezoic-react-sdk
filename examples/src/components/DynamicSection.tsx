...
/** Ids appended one per click, capped at 110. */
const DYNAMIC_IDS: readonly number[] = [104, 105, 106, 107, 108, 109, 110];

/**
 * Appends a new numeric `<EzoicAd>` per click (ids 104–110) — the infinite
...
export function DynamicSection(): ReactElement {
  ...
  const addUnit = (): void => {
    if (atMax) {
      log('Dynamic ads: reached max id (110).');
      return;
    }
  ...
  return (
    <section className="section">
      ...
      <p className="section-desc">
        Each click appends a numeric EzoicAd (ids 104–110) — the infinite-scroll / load-more
